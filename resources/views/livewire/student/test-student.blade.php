        ...
        <div class="space-y-10">
            ...
            @if (count($todayExams) === 0)
                <div class="py-12 text-center">
                    ...
                    <h3 class="mt-2 text-lg font-medium text-gray-900">No Test scheduled for today</h3>
                    <p class="mt-1 text-sm text-gray-500">There are no test scheduled for today. Please check back
                        tomorrow.</p>
                </div>
            @endif
        </div>
